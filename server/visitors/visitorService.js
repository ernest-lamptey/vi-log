...
const addVisitorToDB = (body) => {
    return pool.query(
        `INSERT INTO visits (visitor_name, phone, email, company, purpose, host_id)
        VALUES ($1, $2, $3, $4, $5, $6)`, 
        [body.visitor_name, body.phone, body.email, body.company, body.purpose, Number(body.host_id)]
    )
    .then(res => {
        generateQR(body)
    })
